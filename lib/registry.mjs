...
export const notUndefined = (v) => {
  if (v === undefined) {
    return undefinedValueError
  }
}

export const noisyHandlers = {
  notFound: (path) => {
...
//
export const registry = (validator, handlers) => {
  ...
  const validate = validator,
        ...
        alreadyDefined = handlers.alreadyDefined,
        notValid = handlers.notValid,
        values = {},
        children = {}
