...
const viewGen = function(setup) {
  const injectionSetups = {}
  const injection = function(name, setup) {
...
const __safe = function(safe)  {
  this.buff.push(safe)
}

const __unsafe = function(unsafe) {
...
const __tag = function(name, attrs, setupChildren) {
